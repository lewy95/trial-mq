package cn.xzxy.lewy.kafka.common.handler;
...
public class MybatisCustomTypeHandler extends BaseTypeHandler<Object> {

    public MybatisCustomTypeHandler() {
    }
    ...
    public Object getNullableResult(ResultSet rs, String columnName) throws SQLException {
        ...
        return rs.wasNull() ? "" : dealResult(result);
    }
